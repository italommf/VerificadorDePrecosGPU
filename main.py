...
colunas_para_menor_maior_valor = historico_de_precos.columns[1:]
df_valores = historico_de_precos[colunas_para_menor_maior_valor].applymap(rpa.parse_valor)

planilha_de_controle["Menor Valor Registrado"] = df_valores.min(axis=1)
planilha_de_controle["Maior Valor Registrado"] = df_valores.max(axis=1)
